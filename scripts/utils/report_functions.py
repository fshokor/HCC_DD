...
<div class="box">
  ...
  <div class="grid">
    ...
    {_stat(f"{100*n_total_qc/n_total_raw:.1f} %", "cells passing QC")}
  </div>
...
def generate_target_report(
    ...
    figs = {
        ...
        "dgi_bar"   : _png_to_b64(figures_dir / "dgi_interactions_bar.png"),
    }
...
<div class="box">
  ...
  {_img_tag(figs["dgi_bar"], "Drug-gene interaction counts per gene")}
